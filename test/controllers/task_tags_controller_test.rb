...
class TaskTagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_tag" do
    assert_difference("TaskTag.count") do
      post task_tags_url, params: { task_tag: { color: @task_tag.color, name: @task_tag.name } }
    end
  ...
  test "should update task_tag" do
    patch task_tag_url(@task_tag), params: { task_tag: { color: @task_tag.color, name: @task_tag.name } }
